      ...
      <div className="w-full flex flex-col gap-3">
          <div className='flex flex-col lg:flex-row gap-2 justify-between '>
              ...
              className="flex gap-4 items-center dark:text-white">
                  ...
                  <p className="text-lg font-semibold">Expense Category List</p>
              </Link>
              ...
              <div className="flex items-center gap-3 overflow-hidden">
                  ...
                  <button className="flex  bg-primary-dark hover:bg-primary cursor-pointer text-white px-3 rounded-lg py-1">
                     <p className='text-sm'>Add New Expenese Category</p>
                  </button>
              </div>
          </div>
